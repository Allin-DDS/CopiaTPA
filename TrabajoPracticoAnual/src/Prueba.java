...
public class Prueba {
	public static void main(String[] args) {
		...
		maria.setEdad(22);
		InscripcionSolidaria inscripcionMaria= new InscripcionSolidaria();
		inscripcionMaria.setJugador(maria);
		
		Jugador gordo= new Jugador();
		gordo.setEdad(22);
		InscripcionSolidaria inscripciongordo= new InscripcionSolidaria();
		inscripciongordo.setJugador(gordo);
		
		Jugador jose= new Jugador();
		jose.setEdad(22);
		InscripcionCondicional inscripcionJose= new InscripcionCondicional();
		inscripcionJose.setJugador(jose);
		Condicion condicionJose = new Condicion();
		...
		System.out.println("cantidad de estandar " + semifinal.getCantidadInscriptosEstandar());
